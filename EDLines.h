 ...
 *
 * [1] C. Akinlar and C. Topal, “EDLines: A Real-time Line Segment Detector with a False Detection
 *Control,” Pattern Recognition Letters, 32(13), 1633-1642, DOI: 10.1016/j.patrec.2011.06.001
 *(2011).
 *
...
struct LineSegment
{
  ...
  LineSegment(double _a, double _b, int _invert, double _sx, double _sy, double _ex, double _ey,
...
class EDLines : public ED
{
 public:
  ...
  static void SplitSegment2Lines(double *x, double *y, int noPixels, int segmentNo,
                                 std::vector<LineSegment> &lines, int min_line_len = 6,
 ...
 private:
  ...
  static void ComputeClosestPoint(double x1, double y1, double a, double b, int invert,
                                  double &xOut, double &yOut);
  static void LineFit(double *x, double *y, int count, double &a, double &b, int invert);
  static void LineFit(double *x, double *y, int count, double &a, double &b, double &e,
                      int &invert);
